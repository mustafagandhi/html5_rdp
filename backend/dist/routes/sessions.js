...
const RDPSessionManager_1 = require("../core/RDPSessionManager");
const AuthManager_1 = require("../services/AuthManager");
const Logger_1 = require("../utils/Logger");
const router = express_1.default.Router();
const logger = new Logger_1.Logger('SessionRoutes');
const rdpSessionManager = new RDPSessionManager_1.RDPSessionManager();
...
router.post('/', async (req, res) => {
    try {
        ...
        const { host, port, username, password, domain, enableNLA, enableTLS, enableCredSSP, enableGFX, enableAudio, enableClipboard, enableFileTransfer, enableDeviceRedirection, enablePrinterRedirection, enableSmartCardRedirection, enableUSBRedirection, enableCameraRedirection, enableMicrophoneRedirection, enableSpeakerRedirection, enableMultiMonitor, monitorCount, colorDepth, width, height, quality, frameRate, compressionLevel, encryptionLevel, authenticationLevel, timeout, reconnectAttempts, reconnectDelay } = req.body;
