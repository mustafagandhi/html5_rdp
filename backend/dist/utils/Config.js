    ...
    loadConfig() {
        const config = {
            ...
            rdp: {
                ...
                maxSessionDuration: parseInt(process.env.RDP_MAX_SESSION_DURATION || '28800000')
            },
            websocket: {
            ...
            fileTransfer: {
                maxFileSize: parseInt(process.env.FT_MAX_FILE_SIZE || '100000000'),
                allowedTypes: process.env.FT_ALLOWED_TYPES ? process.env.FT_ALLOWED_TYPES.split(',') : ['*'],
                uploadDir: process.env.FT_UPLOAD_DIR || (0, path_1.join)(process.cwd(), 'uploads'),
                downloadDir: process.env.FT_DOWNLOAD_DIR || (0, path_1.join)(process.cwd(), 'downloads'),
            ...
            audit: {
                ...
                logFile: process.env.AUDIT_LOG_FILE || (0, path_1.join)(process.cwd(), 'logs', 'audit.log'),
        ...
        const configFile = (0, path_1.join)(process.cwd(), 'config.json');
